...
<div className="flex gap-2 mb-4">
  <LLMCopyButton markdownUrl="/docs/sdk/plugin-interface.mdx" />
  <ViewOptions 
    markdownUrl="/docs/sdk/plugin-interface.mdx"
    githubUrl="https://github.com/SimpleNotificationSystem/simplens-docs/blob/main/content/docs/sdk/plugin-interface.mdx"
  />
</div>
