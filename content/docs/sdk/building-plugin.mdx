...
<div className="flex gap-2 mb-4">
  <LLMCopyButton markdownUrl="/docs/sdk/buliding-plugin.mdx" />
  <ViewOptions 
    markdownUrl="/docs/sdk/building-plugin.mdx"
    githubUrl="https://github.com/SimpleNotificationSystem/simplens-docs/blob/main/content/docs/sdk/building-plugin.mdx"
  />
</div>
...
5. **Install plugins** by adding the plugin config to your `simplens.config.yaml` file either manually or using [@simplens/config-gen](/docs/plugins#installing-plugins) tool. SimpleNS automatically installs the plugins from your `simplens.config.yaml` file.
