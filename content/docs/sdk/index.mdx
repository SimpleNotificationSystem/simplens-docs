...
<div className="flex gap-2 mb-4">
  <LLMCopyButton markdownUrl="/docs/sdk.mdx" />
  <ViewOptions 
    markdownUrl="/docs/sdk.mdx"
    githubUrl="https://github.com/SimpleNotificationSystem/simplens-docs/blob/main/content/docs/sdk/index.mdx"
  />
</div>
