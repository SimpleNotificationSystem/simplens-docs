...
<div className="flex gap-2 mb-4">
  <LLMCopyButton markdownUrl="/docs/sdk/api-reference.mdx" />
  <ViewOptions 
    markdownUrl="/docs/sdk/api-reference.mdx"
    githubUrl="https://github.com/SimpleNotificationSystem/simplens-docs/blob/main/content/docs/sdk/api-reference.mdx"
  />
</div>
...
[View full documentation →](/docs/sdk/plugin-interface)
