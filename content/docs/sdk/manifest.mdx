...
<div className="flex gap-2 mb-4">
  <LLMCopyButton markdownUrl="/docs/sdk/manifest.mdx" />
  <ViewOptions 
    markdownUrl="/docs/sdk/manifest.mdx"
    githubUrl="https://github.com/SimpleNotificationSystem/simplens-docs/blob/main/content/docs/sdk/manifest.mdx"
  />
</div>
