...
<div className="flex gap-2 mb-4">
  <LLMCopyButton markdownUrl="/docs/sdk/utilities.mdx" />
  <ViewOptions 
    markdownUrl="/docs/sdk/utilities.mdx"
    githubUrl="https://github.com/SimpleNotificationSystem/simplens-docs/blob/main/content/docs/sdk/utilities.mdx"
  />
</div>
