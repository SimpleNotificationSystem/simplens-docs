...
<Cards>
  <Card title="📊 Dashboard Features" href="./admin-dashboard">
    Learn about monitoring, retries, and alerts
  </Card>
  <Card title="📖 API Reference" href="./api-reference">
    Explore all API endpoints and options
  </Card>
  <Card title="⏰ Scheduled Notifications" href="./core-concepts#scheduled-delivery">
    Queue notifications for future delivery
  </Card>
  <Card title="🔔 Webhooks" href="./core-concepts#webhooks">
    Get real-time status updates
  </Card>
  <Card title="📡 Multi-Channel" href="./api-reference#multi-channel-requests">
...
<Cards>
  <Card title="🖥️ API Server" href="http://localhost:3000">
    Notification API - Port 3000
  </Card>
  <Card title="📊 Admin Dashboard" href="http://localhost:3002">
    Monitoring & management - Port 3002
  </Card>
  <Card title="📈 Grafana" href="http://localhost:3001">
    Log visualization - Port 3001
  </Card>
  <Card title="📨 Kafka UI" href="http://localhost:8080">
