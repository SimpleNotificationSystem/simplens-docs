...
import { Plug, Package, Bell, BarChart, TrendingUp } from 'lucide-react';

<div className="flex gap-2 mb-4">
  <LLMCopyButton markdownUrl="/docs/core/installation.mdx" />
  <ViewOptions 
    markdownUrl="/docs/core/installation.mdx"
    githubUrl="https://github.com/SimpleNotificationSystem/simplens-docs/blob/main/content/docs/core/installation.mdx"
  />
</div>
