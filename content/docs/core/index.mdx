...
import { Plug, RefreshCw, Shield, Clock, TrendingUp, Radio, TrafficCone, Bell, BarChart, ClipboardList, Target, AlertTriangle, Shuffle, Package} from 'lucide-react';

<div className="flex gap-2 mb-4">
  <LLMCopyButton markdownUrl="/docs/core.mdx" />
  <ViewOptions 
    markdownUrl="/docs/core.mdx"
    githubUrl="https://github.com/SimpleNotificationSystem/simplens-docs/blob/main/content/docs/core/index.mdx"
  />
</div>
...
<Cards>
  ...
  <Card title={<><ClipboardList className="inline w-5 h-5 mr-2" /> Observability</>}>
...
<Accordions>
  <Accordion id="transactional" title={<><Package className="inline w-5 h-5 mr-2" /> Transactional Notifications</>}>
    Order confirmations and receipts, password reset emails, account verification messages, and payment notifications.
  </Accordion>
  <Accordion id="engagement" title={<><Target className="inline w-5 h-5 mr-2" /> User Engagement</>}>
    Marketing campaigns, product announcements, reminders and follow-ups, and re-engagement campaigns.
  </Accordion>
  <Accordion id="alerts" title={<><AlertTriangle className="inline w-5 h-5 mr-2" /> System Alerts</>}>
    Server monitoring alerts, error notifications, performance degradation warnings, and security alerts.
  </Accordion>
  <Accordion id="multichannel" title={<><Shuffle className="inline w-5 h-5 mr-2" /> Multi-Channel Communication</>}>
  ...
  <Accordion id="highvolume" title={<><BarChart className="inline w-5 h-5 mr-2" /> High-Volume Delivery</>}>
...
<Callout type="note">
For detailed architecture information, see [Architecture](/docs/core/architecture).
</Callout>
...
Ready to get started? Check out our [Getting Started Guide](/docs/core/getting-started) to have SimpleNS running under a minute.
