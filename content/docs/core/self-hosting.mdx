...
<Callout type="info">
SimpleNS can also be hosted easily on cloud providers using prebuilt Terraform templates: [SimpleNS Terraform Templates](https://github.com/SimpleNotificationSystem/simplens-terraform-templates).
</Callout>
